...
struct missile_avionics : module {
    ...
    double get_time_to_impact_first_degree_prediction(vector::worldspace current_detection_relative_worldspace, vector::worldspace last_detection_worldspace, physics_object::object* parent);
    ...
    vector::localspace get_guidance_target_velocity(vector::worldspace current_detection_relative_worldspace, vector::worldspace last_detection_worldspace, physics_object::object* parent, double gain);
    vector::localspace get_guidance_first_degree_prediction(vector::worldspace current_detection_relative_worldspace, vector::worldspace last_detection_worldspace, physics_object::object* parent, double gain);
    vector::localspace get_guidance_proportional_navigation(vector::worldspace current_detection_relative_worldspace, vector::worldspace last_detection_worldspace, physics_object::object* parent, double gain);
};
